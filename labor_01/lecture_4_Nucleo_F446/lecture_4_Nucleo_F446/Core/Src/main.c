...
int main(void)
{
  ...
  uint32_t GPIOD_base_addr = 0x40020400;   // GPIOB base address
  ...
  /* GPIOB periféria órajel engedélyezése */
  *RCC_AHB1 |= 0x00000002;


  /* PB0 kimenetre állítása */
  *GPIO_MODDER_addr &= ~0x00000003;
  *GPIO_MODDER_addr |=  0x00000001;


  /* Push-pull */
  *GPIO_OTYPER_addr &= ~0x00000001;


  /* Low speed */
  *GPIO_OSPEEDR_addr &= ~0x00000003;


  /* No pull-up / pull-down */
  *GPIO_PUPDR_addr &= ~0x00000003;


  /* PB0 kezdetben LOW */
  *GPIO_ODR_addr &= ~0x00000001;
  ...
  while (1)
  {
	  ...
	  HAL_Delay(500);// Wait for 500 milliseconds (clk = 25 MHz)
